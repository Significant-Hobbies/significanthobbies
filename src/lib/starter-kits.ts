...
export const STARTER_KITS: StarterKit[] = [
  {
    ...
    upgradePath: 'Borrow a camera, print a small set locally, or try a weekend golden-hour route.',
  ...
  },
  {
    ...
    upgradePath: 'Add one contrasting plant, start seeds, or join a local plant swap.',
  ...
  },
  {
    ...
    supplies: ['Cheap sketchbook', 'Black pen', 'Timer', 'Three everyday objects'],
    firstExperiment:
      'Draw the same object three times: 2 minutes, 8 minutes, then 15 minutes. Label what improved.',
    successSignal: 'The third drawing is not perfect, but it clearly shows better observation.',
    upgradePath: 'Try a local figure drawing night, a library art book, or a basic pencil set.',
  ...
  },
  {
    ...
    upgradePath: 'Map a 5K route, visit a local running store, or join a beginner group run.',
  ...
  },
  {
    ...
    supplies: ['Chess board or free app', 'One beginner puzzle set', 'Score sheet or notebook'],
    firstExperiment:
      'Solve 10 mate-in-one puzzles, play one slow game, then write down the first mistake you noticed.',
    successSignal: 'You can name one tactic or pattern you missed before the session.',
    upgradePath: 'Attend a local club night, study basic endgames, or play one weekly rated game.',
  ...
  },
  {
    ...
    upgradePath: 'Make stock, visit a spice shop, or host a low-pressure soup night.',
    relatedHobbies: ['Cooking', 'Fermentation', 'Hosting dinners'],
  },
];

export const STARTER_KIT_CATEGORIES = [...new Set(STARTER_KITS.map((kit) => kit.category))];

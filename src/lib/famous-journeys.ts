...
export const FAMOUS_JOURNEYS: FamousJourney[] = [
  {
    ...
    name: 'Steve Jobs',
    knownFor:
      'Co-founder of Apple; revolutionized personal computing, smartphones, and digital media',
    emoji: '💻',
    born: '1955–2011',
    phases: [
      {
  ...
  },
  {
    ...
    name: 'Elon Musk',
    knownFor:
      'CEO of Tesla and SpaceX; pushing boundaries of electric vehicles, space exploration, and AI',
    emoji: '🚀',
    born: 'b. 1971',
    phases: [
      {
      ...
      },
      {
        ...
        hobbies: [
          ...
          'Anime',
          'Reading (biographies, physics, AI research)',
        ],
      },
    ],
    surprisingHobbies: [
  ...
  },
  {
    ...
    name: 'Keanu Reeves',
    knownFor:
      'Actor (The Matrix, John Wick); widely regarded as one of the kindest people in Hollywood',
    emoji: '🎬',
    born: 'b. 1964',
    phases: [
      {
        ...
        hobbies: [
          "Ice hockey (promising goalie, nicknamed 'The Wall')",
    ...
    phases: [
      {
        ...
        hobbies: [
          'Violin (introduced at age 5)',
          'At 13, discovered Mozart and fell in love with music',
        ],
      },
      {
        label: 'College / Early Career',
        hobbies: [
          'Violin practice',
          'Sailing',
          'Philosophical reading (Hume, Spinoza, Schopenhauer)',
        ],
      },
      {
        label: 'Peak Career (Princeton years)',
        hobbies: [
          'Violin (never traveled without it)',
          'Piano improvisation',
          'Sailing',
          'Travel journals',
        ],
  ...
  },
  {
    ...
    name: 'Oprah Winfrey',
    knownFor:
      'Media mogul, talk show host, philanthropist; one of the most influential women in the world',
    emoji: '📚',
    born: 'b. 1954',
    phases: [
      {
        ...
        hobbies: [
          'Public speaking (reciting in church from age 3)',
          'Reading',
      ...
      },
      {
        label: 'Peak Career',
        hobbies: [
          "Reading (Oprah's Book Club)",
          'Poetry (reads every evening)',
          'Cooking',
          'Gardening',
          'Hiking',
          'Photography',
  ...
  },
  {
    ...
    phases: [
      ...
      },
      {
        label: 'Peak Career',
        hobbies: [
          'Reading (pre-game ritual since 2012 playoffs)',
          'Golf',
  ...
  },
  {
    ...
    name: 'Julia Child',
    knownFor:
      'Celebrity chef who brought French cuisine to the American public; iconic TV personality',
    emoji: '👩‍🍳',
    born: '1912–2004',
    phases: [
      {
      ...
      },
      {
        ...
        hobbies: [
          'Government work',
          'OSS spy (WWII, top secret clearance)',
          'Developing shark repellent',
        ],
      },
      {
  ...
  },
  {
    ...
    knownFor:
      'Chef, author, and TV host (No Reservations, Parts Unknown); redefined food and travel media',
    emoji: '✈️',
    born: '1956–2018',
    phases: [
      {
        ...
        hobbies: [
          ...
          'Drawing (wanted to draw comics professionally)',
          'Literature',
          'Boy Scouts',
        ],
      },
      {
        label: 'Teens / Early Career',
        hobbies: [
          'Punk rock (the Ramones, Dead Boys)',
          'Writing (literary magazine submissions)',
          'Selling comics to fund other habits',
        ],
      },
      {
  ...
  },
  {
    ...
    name: 'Vera Wang',
    knownFor:
      'Iconic fashion designer; transformed the bridal industry; started her fashion career at age 40',
    emoji: '👗',
    born: 'b. 1949',
    phases: [
      {
        label: 'Childhood / Teens',
        hobbies: [
          'Competitive figure skating (from age 8)',
          'Competed at 1968 U.S. National Championships',
        ],
      },
      {
        label: 'College / Early Career (post-skating)',
        hobbies: [
          'Fashion (realized passion during semester in Paris)',
          'Magazine editing (Vogue, 17 years)',
          'Design direction (Ralph Lauren)',
        ],
      },
      {
      ...
      },
      {
        ...
        hobbies: [
          ...
          'Olympic figure skating costume design (Kerrigan, Kwan, Lysacek, Nathan Chen)',
        ],
      },
    ],
    surprisingHobbies: [
  ...
  },
  {
    ...
    knownFor:
      'Nobel Prize-winning physicist; worked on the Manhattan Project; legendary science communicator',
    emoji: '⚛️',
    born: '1918–1988',
    phases: [
      {
        label: 'Childhood / Teens',
        hobbies: [
          'Radio tinkering and repair',
          'Mathematics puzzles',
          'Taking things apart compulsively',
        ],
      },
      {
  ...
  },
  {
    ...
    knownFor:
      'Tennis champion with 23 Grand Slam singles titles; one of the greatest athletes of all time',
    emoji: '🎾',
    born: 'b. 1981',
    phases: [
      {
    ...
    phases: [
      {
        label: 'Childhood / Teens',
        hobbies: [
          'Entrepreneurial hobbies from age 6 (selling Coca-Cola, newspapers, golf balls)',
          'Obsessive financial reading',
        ],
      },
      {
        label: 'College',
      ...
      },
      {
        ...
        hobbies: [
          'Bridge (~12 hours per week, often with Bill Gates)',
          'Ukulele (plays at Berkshire shareholder meetings, charity events)',
          'Reading (80% of his work day)',
        ],
      },
    ],
    surprisingHobbies: [
  ...
  },
  {
    ...
    phases: [
      ...
      },
      {
        label: 'Peak Career',
        hobbies: [
          'Extensive cycling tours throughout Europe (with Pierre)',
          'Gardening and nature walks',
          "Raising two daughters alone after Pierre's death",
        ],
      },
    ],
    surprisingHobbies: [
  ...
  },
  {
    ...
    name: 'Barack Obama',
    knownFor:
      '44th President of the United States; first African American president; author and constitutional law professor',
    emoji: '🏛️',
    born: 'b. 1961',
    phases: [
      {
        ...
        hobbies: [
          'Basketball (varsity team, Punahou School)',
          'Reading (Spider-Man, Conan the Barbarian comics)',
          'Body surfing',
        ],
      },
      {
    ...
    phases: [
      {
        label: 'Childhood',
        hobbies: [
          'Reading (World Book encyclopedia by age 8)',
          'Math',
          'Chess',
      ...
      },
      {
        label: 'Career Peak',
        hobbies: [
          'Think Weeks (solo cabin reading retreats)',
  ...
  },
  {
    ...
    phases: [
      ...
      },
      {
        label: 'Teens',
        hobbies: [
          'Fencing (team captain, Phillips Exeter)',
      ...
      },
      {
        label: 'Career',
        hobbies: [
          'Annual personal challenges (Mandarin, running, AI building)',
      ...
      },
      {
        label: 'Later Life',
        hobbies: [
          'Brazilian jiu-jitsu and MMA (competing)',
          'Hydrofoiling',
          'Surfing',
          'Barbecuing',
        ],
    ...
    phases: [
      {
        ...
        hobbies: [
          ...
          'Sci-fi reading (Asimov, Heinlein)',
          'Playing Star Trek with friends',
          'Ranch work (Texas summers)',
        ],
      },
      {
        label: 'Teens',
  ...
  },
  {
    ...
    name: 'Beyoncé',
    knownFor:
      'Singer, songwriter, dancer, actress — one of the best-selling music artists of all time',
    emoji: '🐝',
    born: 'b. 1981',
    phases: [
      {
        label: 'Childhood',
        hobbies: [
          'Dance classes (from age 7)',
          'Talent shows (won 35 consecutive local competitions)',
          'Opera voice lessons (age 9)',
        ],
      },
      {
        label: 'Teens',
        hobbies: [
          'Running a mile while singing (stamina training)',
          'Obsessive repetition practice',
        ],
      },
      {
        label: 'Career Peak',
      ...
      },
      {
        label: 'Later Life',
        hobbies: [
          'Beekeeping (80,000 bees, produces hundreds of jars of honey)',
          'Italian cooking',
          'Family',
        ],
      },
  ...
  },
  {
    ...
    name: 'Lady Gaga',
    knownFor:
      'Pop icon, singer, songwriter, actress (A Star is Born, House of Gucci), fashion provocateur',
    emoji: '🎤',
    born: 'b. 1986',
    phases: [
      {
        label: 'Childhood',
        hobbies: [
          'Piano (self-taught by ear at age 4)',
          'Piano lessons',
      ...
      },
      {
        label: 'Career',
        hobbies: [
          'Italian cooking (loves pasta)',
          'Horror movies (watches to fall asleep)',
          'Makeup as creative art',
        ],
      },
      {
        label: 'Later Life',
        hobbies: [
          ...
          'HAUS Laboratories cosmetics (hobby-turned-business)',
  ...
  },
  {
    ...
    name: 'Post Malone',
    knownFor:
      'Rapper, singer, songwriter — genre-blending artist spanning hip-hop, pop, country, and rock',
    emoji: '🎵',
    born: 'b. 1995',
    phases: [
      {
      ...
      },
      {
        label: 'Teens',
        hobbies: [
          'Guitar Hero (led to learning real guitar)',
          'Minecraft (joined Team Crafted YouTube group)',
          'Metalcore music',
        ],
      },
      {
      ...
      },
      {
        ...
        hobbies: [
          "Beer pong (professional level, filed trademark for 'World Pong League')",
          'Medieval sword and armor collecting and forging',
          'Magic: The Gathering (ultra-rare card collecting)',
          'Custom Crocs design',
          'Firearms',
        ],
      },
  ...
  },
  {
    ...
    phases: [
      ...
      },
      {
        ...
        hobbies: [
          'Art school',
          'Mime (trained under Lindsay Kemp — his primary income when music flopped)',
        ],
      },
      {
        label: 'Career',
        hobbies: [
          'Painting (neo-expressionist, post-modern)',
          'Writing art criticism for Modern Painters magazine',
          'Art collecting',
        ],
      },
      {
        label: 'Later Life',
        hobbies: [
          'Reading (published 100 favorite books list)',
          'Traveling by ocean liner (afraid of flying)',
          'Contemporary music discovery',
        ],
      },
    ],
    surprisingHobbies: [
  ...
  },
  {
    ...
    phases: [
      ...
      },
      {
        ...
        hobbies: [
          'Typewriter restoration (a Cleveland restorer introduced him to steel machines)',
          'Hermes 2000 (cornerstone of his collection)',
        ],
      },
      {
        label: 'Career Peak',
        hobbies: [
          'Typewriter collecting (amassed nearly 250)',
          'Creating a typewriter app for Apple',
      ...
      },
      {
        label: 'Later Life',
        hobbies: [
          'Giving away his collection (one lovingly wrapped typewriter at a time)',
          'Writing',
          'Philanthropy',
        ],
      },
  ...
  },
  {
    ...
    name: 'Meryl Streep',
    knownFor:
      'Most nominated actor in Academy Award history (21 nominations); considered the greatest living actress',
    emoji: '🎭',
    born: 'b. 1949',
    phases: [
      {
        label: 'Childhood',
        hobbies: [
          'NYC trips with her mother (museums, Broadway, United Nations)',
          'School recitals',
        ],
      },
      {
        label: 'Teens',
        hobbies: [
          'Opera lessons (with famed teacher Estelle Liebling, age 12–16)',
          'Cheerleading',
          'High school theater',
        ],
      },
      {
        label: 'Career',
        hobbies: [
          'Knitting (expert level — taught Amy Adams to knit on set)',
          'Learning instruments for roles',
          'Reading poetry',
        ],
      },
      {
    ...
    phases: [
      {
        label: 'Childhood',
        hobbies: [
          'Chess (daily games with his father from age 8)',
          'Physical fitness (interest from age 14)',
        ],
      },
      {
        label: 'Teens / Military',
        hobbies: [
          'Weight training (started at 15)',
          'Tank operation (Austrian military, M47 Patton)',
      ...
      },
      {
        label: 'Career',
        hobbies: [
          'Chess (plays on movie sets between takes)',
          'Horseback riding',
          'Scuba diving',
          'Skiing',
          'Motorcycles',
      ...
      },
      {
        label: 'Later Life',
        hobbies: [
          'Chess (plays with Chris Pratt, hosts chess at Arnold Classic)',
          'Reading',
          'Classical music',
          'Art appreciation',
        ],
  ...
  },
  {
    ...
    name: 'Stephen King',
    knownFor:
      'Author of horror and thriller novels (The Shining, IT, The Stand); one of the best-selling authors of all time',
    emoji: '📖',
    born: 'b. 1947',
    phases: [
      {
      ...
      },
      {
        label: 'Career',
        hobbies: [
          'Rock guitar (co-founded the Rock Bottom Remainders with authors Dave Barry, Amy Tan, Barbara Kingsolver)',
          'Red Sox fandom',
          'Bowling',
          'Jigsaw puzzles',
        ],
      },
      {
        label: 'Later Life',
        hobbies: [
          'Writing pop culture criticism for Entertainment Weekly',
          'Reading',
          'Guitar (privately)',
        ],
      },
  ...
  },
  {
    ...
    knownFor:
      'Japanese novelist (Norwegian Wood, 1Q84, Kafka on the Shore); one of the most translated living authors',
    emoji: '🏃',
    born: 'b. 1949',
    phases: [
      {
        label: 'Teens',
        hobbies: [
          'Jazz (discovered at age 15, Art Blakey concert in Kobe)',
      ...
      },
      {
        label: 'Young Adult',
        hobbies: [
          "Running a jazz bar and coffeehouse ('Peter Cat')",
          'Vinyl collecting (over 10,000 records)',
        ],
      },
      {
        label: 'Career',
        hobbies: [
          'Marathon running (started 1982 when he became a full-time novelist)',
          'Reading (one hour afternoons, one hour before bed)',
      ...
      },
      {
        label: 'Later Life',
        hobbies: [
          'Hosting radio shows on writing and records',
          'Running',
          'Reading',
          'Vinyl collecting (preserved at Waseda University)',
        ],
      },
    ],
    surprisingHobbies: [
    ...
    phases: [
      {
        ...
        hobbies: [
          'Street football (missed meals to play, escaped through his bedroom window with a ball)',
        ],
      },
      {
      ...
      },
      {
        ...
        hobbies: [
          ...
          'Table tennis',
          'Cycling',
          'Luxury car collecting (19+ vehicles)',
          'Bingo (learned at Manchester United)',
          'Contemporary art collecting (Banksy, Jeff Koons)',
        ],
      },
      {
        label: 'Later Life',
        hobbies: [
          'Surfing (secretly, in Madeira)',
    ...
    phases: [
      ...
      },
      {
        ...
        hobbies: [
          ...
          'Cultural travel',
          'Language learning (fluent in German, French, English, Swiss German)',
        ],
      },
      {
  ...
  },
  {
    ...
    name: 'Simone Biles',
    knownFor:
      'Most decorated gymnast in history, 37 World and Olympic medals, mental health advocate',
    emoji: '🤸',
    born: 'b. 1997',
    phases: [
      {
        label: 'Childhood',
        hobbies: [
          'Gymnastics (discovered on a daycare field trip at age 6)',
          'Finding stability in training',
        ],
      },
      {
        ...
        hobbies: [
          ...
          'Movies (Divergent, Pretty Little Liars)',
      ...
      },
      {
        ...
        hobbies: [
          ...
          'Pilates',
          'Long walks',
          'Therapy and spa days with husband',
        ],
      },
    ],
    surprisingHobbies: [
  ...
  },
  {
    ...
    knownFor:
      'Renaissance polymath — painter (Mona Lisa, The Last Supper), inventor, scientist, and anatomist',
    emoji: '🎨',
    born: '1452–1519',
    phases: [
      {
      ...
      },
      {
        ...
        hobbies: [
          "Music (arrived at Duke Sforza's court primarily as a musician with a handmade lyre)",
          'Singing',
          'Anatomy dissection',
        ],
      },
      {
        label: 'Career',
        hobbies: [
          'Human anatomy (dissected 30+ corpses)',
          'Invention (parachutes, underwater breathing, armored cars)',
          'Notebook keeping (painting, architecture, mechanics, anatomy)',
  ...
  },
  {
    ...
    phases: [
      ...
      },
      {
        ...
        hobbies: [
          'Watercolors (started during family holiday 1915 after Gallipoli resignation)',
          'Oil painting (quickly switched)',
        ],
      },
      {
        label: 'Middle Life (Chartwell Estate)',
        hobbies: [
          "Bricklaying (got an apprentice card in the bricklayers' union)",
          'Landscaping (built lakes, rockery, waterfall)',
          'Animal keeping (ducks, black swans, goldfish, pigs, cats)',
        ],
      },
      {
        label: 'Later Life',
        hobbies: [
          'Painting (500+ works total)',
          'Writing (Nobel Prize in Literature 1953)',
          'Gardening',
        ],
      },
    ],
    ...
    phases: [
      {
        label: 'Childhood',
        hobbies: [
          'Swimming (lifelong passion from childhood in Boston)',
          'Kite flying (used a kite to pull himself across a pond)',
          "Reading (couldn't remember a time when he couldn't read)",
        ],
      },
      {
        label: 'Young Adult',
        hobbies: [
          "Writing and publishing (Poor Richard's Almanack)",
          'Chess (one of the earliest players in America)',
          'Printing',
        ],
      },
      {
        ...
        hobbies: [
          ...
          'Invention (lightning rod, bifocals, Franklin stove, glass armonica)',
    ...
    phases: [
      {
        ...
        hobbies: [
          'Soccer',
          'Swimming',
          'Boxing and wrestling (encouraged by her father to aid recovery from polio)',
          'Pre-med studies (dreamed of becoming a doctor)',
        ],
      },
      {
        label: 'Teens (after bus accident at 18)',
        hobbies: [
          'Painting in bed (her mother had a special easel made)',
          "Oil painting (using her father's brushes)",
        ],
      },
      {
        label: 'Career',
        hobbies: [
          'Painting (143 works, 55 self-portraits)',
          'Political activism (Mexican Communist Party)',
          'Tehuana dress as creative identity',
        ],
      },
      {
        label: 'Later Life',
  ...
  },
  {
    ...
    phases: [
      ...
      },
      {
        ...
        hobbies: [
          'Golf (obsessively during off-seasons)',
          'Gambling (well-documented)',
          'Competitive games of any kind',
        ],
      },
      {
      ...
      },
      {
        ...
        hobbies: [
          'Golf (built private course The Grove XXIII in Hobe Sound, Florida)',
          'Fishing (to learn patience for golf)',
          'Team ownership (Charlotte Hornets)',
          'Tequila brand (Cincoro)',
        ],
      },
    ],
    surprisingHobbies: [

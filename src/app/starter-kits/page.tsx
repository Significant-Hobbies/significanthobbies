    ...
    <div className="mx-auto max-w-5xl px-4 py-12">
      ...
      <section className="mb-10 max-w-3xl">
        ...
        <p className="mt-4 text-lg leading-relaxed text-stone-500">
          Each kit is designed for one small experiment using materials you can
          find nearby. Pick a kit, run the first experiment, then decide whether
          the hobby deserves a second session.
        </p>
      </section>
      ...
      <section className="mt-12 rounded-xl border border-emerald-200 bg-emerald-50 p-6 text-center">
        <h2 className="text-xl font-bold text-stone-900">
          Want a more personal shortlist?
        </h2>
        <p className="mx-auto mt-2 max-w-2xl text-sm leading-relaxed text-stone-600">
          Take the hobby quiz first, then use the starter kit closest to your
          recommended hobby as a low-risk experiment.
        </p>
        <Link

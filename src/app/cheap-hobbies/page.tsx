  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <p className="text-lg text-stone-500 mb-4 leading-relaxed">
        The most rewarding hobbies usually aren&apos;t the expensive ones. Running, reading, writing, chess, hiking, drawing — these cost nothing, and some of the deepest hobbyists in the world practice them.
      </p>
      <p className="text-lg text-stone-500 mb-8 leading-relaxed">
        This list is honest: we&apos;ve included 15 completely free hobbies and 10 that cost under $50 to start, with a real breakdown of what you actually need. No filler, no &quot;you&apos;ll need to upgrade your gear&quot; bait-and-switch.
      </p>
      ...
      <section id="free" className="mb-12">
        <div className="border-l-4 border-emerald-400 pl-4 mb-6">
          ...
          <p className="text-stone-500 mt-1 text-sm">
            Zero dollars required to start. These hobbies are free indefinitely — no catch, no upgrade required.
          </p>
        </div>
      ...
      <section id="cheap">
        <div className="border-l-4 border-blue-400 pl-4 mb-6">
          ...
          <p className="text-stone-500 mt-1 text-sm">
            A small upfront investment, then free forever. These are the hobbies where one purchase gives you years of practice.
          </p>
        </div>
        <ul className="space-y-4">
      ...
      <div className="mt-10 rounded-xl bg-stone-50 border border-stone-200 p-6">
        ...
        <p className="text-sm text-stone-600 leading-relaxed">
          The most expensive part of any hobby is the time you invest in it. Choose based on what genuinely interests you, not what gear looks coolest. The hobby that sticks is the one you&apos;ll actually do — usually the one with the lowest friction to start.
        </p>
      </div>
      ...
      <div className="mt-12 rounded-xl bg-emerald-50 border border-emerald-200 p-8 text-center">
        ...
        <p className="text-stone-500 mb-4">
          Take our 2-minute quiz for personalized recommendations. We&apos;ll ask about your schedule, budget, and what you want to get out of a hobby.
        </p>
        <Link

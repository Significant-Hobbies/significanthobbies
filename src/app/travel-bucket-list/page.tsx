...
const EUROPE: Destination[] = [
  {
    ...
    famous: { name: "Barack Obama", slug: "barack-obama", note: "visited during a G8 trip and described it as genuinely awe-inspiring" },
  },
  {
...
const AFRICA_MIDDLE_EAST: Destination[] = [
  {
    ...
    famous: { name: "Oprah Winfrey", slug: "oprah-winfrey", note: "has spoken about the Serengeti as a transformative experience" },
  },
  {
    name: "Namibia",
    why: "The oldest desert on earth, red sand dunes, wild horses, and a coastline where fog rolls in from a cold sea.",
    famous: { name: "Bill Clinton", slug: "bill-clinton", note: "visited post-presidency and described Namibia as one of Africa's most extraordinary landscapes" },
  },
  {
...
const REGION_STYLES: Record<string, { bg: string; border: string; text: string; badge: string; dot: string }> = {
          ...
          return (
            <section key={region.id} id={region.id} className="scroll-mt-28 space-y-6">
              <div className="flex items-center gap-3">
                <div className={`h-10 w-10 rounded-xl border ${s.border} ${s.bg} flex items-center justify-center text-xl`}>
                  {region.emoji}
                </div>
                <div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="space-y-1 min-w-0">
                          <div className="flex items-center gap-2">
                            ...
                            <h3 className="font-semibold text-stone-900 text-sm leading-snug">{dest.name}</h3>
                          </div>

        ...
        {OPTIONS.map((opt) => {
          ...
          return (
            <DropdownMenuItem
              ...
              className="flex items-start gap-3 py-2 cursor-pointer hover:bg-foreground/5 focus:bg-foreground/5"
            >
              <OptIcon className="h-4 w-4 mt-0.5 text-muted-foreground shrink-0" />
              <div>

...
The existing `com.significanthobbies.app` identity and local document remain unchanged so current entries survive the split. Live and Habits data stays preserved in the archive but is no longer exposed by the Journal interface. Account sync remains revisioned and optional; the app is fully useful offline.
...
- Complete morning/evening reflection, writing, date navigation, and archive flows on physical iPhone and iPad hardware.

...
- The Astro Hub and Live overlays are covered by the `landing` Playwright
  project. The deploy smoke check verifies seven Hub cards and the cinematic
  Live page on its custom domain.

# SignificantHobbies v1 — Design Document (archive)

> **Archive snapshot.** The original 2026-03-01 v1 design. Several choices
> here were superseded (Prisma → Drizzle, NextAuth → better-auth, Next 14 →
> Next 16, Prisma models → Drizzle schema). Preserved as the durable record of
> the initial product thesis. Current architecture lives in
